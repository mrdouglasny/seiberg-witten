...
\paragraph{One principle, specialized.} The seven are not independent postulates but facets of
\textbf{N=2 supersymmetry} read off the Coulomb branch: SUSY fixes the special-K\"ahler prepotential
...
projections} of one structure rather than seven siblings, and the matter and higher-rank theories
