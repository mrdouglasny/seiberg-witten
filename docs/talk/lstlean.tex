...
open, as, export, override, axiom, axioms, inductive, data, codata, with, without,
structure, record, universe, universes, coinductive,
alias, help, precedence, reserve, declare_trace, add_key_equivalence,
match, infix, infixl, infixr, notation, postfix, prefix, instance,
coercion, end, this, suppose,
...
% Commands
morekeywords=[3]{\#eval, \#reduce, \#check},
